 ...
 * {@link GoanFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link GoanFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GoanFragment extends Fragment {
     ...
     * @return A new instance of fragment GoanFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GoanFragment newInstance(String param1, String param2) {
        GoanFragment fragment = new GoanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_goan, container, false);
    ...
    private class NewsRequest extends AsyncTask<Void, Void, List<News>> {
        ...
        protected List<News> doInBackground(Void... params) {
            ...
            try {
                Document html = Jsoup.connect("https://chronicler.in/category/top-stories/").followRedirects(true)
                ...
                Elements category = html.select("div.content-area h1.entry-title a");
                Elements time     = html.select("div.content-area div.entry-meta span.posted-on time");
                Elements summary  = html.select("div.content-area div.entry-content p");
                ...
                //for (Element element:category){
                    ...
                    news.setImgUrlNews(images.get(i).attr("src"));
                    newses.add(news);
                    //i++;
                }
            } catch (IOException e) {
